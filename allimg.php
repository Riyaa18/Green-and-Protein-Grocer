                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                            ...
                            <td><img src='images/gallery/<?php echo "$result[1]"; ?>' style="height: 80px; width:100px;     border-radius:0%;"></td>
                            <td><a href="imgdlt.php?id1=<?php echo "$result[0]";?>" class="text-danger" style="text-decoration: none;">Delete</a></td>
                        </tr>
                      <?php
                      $i++;
                      }
