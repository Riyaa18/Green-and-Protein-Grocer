    ...
    <div class="container-scroller">
      ...
      <?php
        if(isset($_POST['btn1']))
        {
            ...
            $target_files='images/gallery/';
            move_uploaded_file($image, $target_files.basename($image_name));
            $q2="INSERT INTO `gallery`(`image`) VALUES ('$image_name')";
                ...
                <div class="card-body">
                  <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="file"
                        class="form-control" name="img" id="img" onchange=fun1(event) aria-describedby="helpId" required>
