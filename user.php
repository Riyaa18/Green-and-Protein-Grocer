                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                            ...
                            <td><img src='images/user/<?php echo "$result[3]"; ?>' style="height: 80px; width:100px;     border-radius:0%;"></td>
                            <td><a href="uview.php?id1=<?php echo "$result[0]";?>" style="text-decoration: none; font-size: 22px;" class="text-warning"><i class="mdi mdi-eye"></i></a></td>
                        </tr>
                      <?php
                      $i++;
                      }
